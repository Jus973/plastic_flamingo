  ...
  build: {
    rollupOptions: {
      input: {
        ...
        checkoutShipping: resolve(__dirname, 'checkout/shipping/index.html'),
        checkoutPayment: resolve(__dirname, 'checkout/payment/index.html'),
        ...
        stressEdgeCases: resolve(__dirname, 'stress/edge-cases/index.html'),
        stressBrokenForms: resolve(__dirname, 'stress/broken-forms/index.html'),
      },
    },
  },
})
